...
import useLocationFetcher from "../utills/getLocation/GetStateFromIP";
...
const CheckoutPage = () => {
  ...
  useEffect(() => {
    api
      .checkOut({
        ...
        // state: location.location ?? location.location,
        state: "ohio",
      })
      .then((res) => {
        setCartItems(res);
  ...
  const subtotal = cartItems?.cartdata?.reduce(
    (sum, item) => sum + item.price * item.qty,
    0
  );
  const shippingCost = cartItems?.cartdata?.reduce(
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6 mb-6 h-fit">
              ...
              {cartItems?.cartdata?.length > 0 ? (
                <div className="space-y-6">
                  {cartItems?.cartdata?.map((item: any, index: any) => (
                    <div
                      key={item.id}
                      ...
                      <div className="flex-grow">
                        ...
                        >
                          -
                            ...
                            <span className="px-3 py-1">Qty: {item?.qty}</span>
                            {/* <button
                          disabled={true}
                          className="px-3 py-1 text-gray-600 hover:bg-gray-100"
                          // onClick={() =>
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6 mb-6">
              ...
              <div className="space-y-2 mb-4">
                <div className="flex justify-between">
                  <span>Item({cartItems?.cartdata?.length})</span>
                  <span>${subtotal}</span>
                </div>
                {/* <div className="flex justify-between">
              <span>Shipping</span>
          ...
          "
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  {paymentMethod === "card" && <CheckoutForm />}
                </div>
                ...
                <div className="flex justify-between mt-6">
                  <button
                    onClick={() => navigate("/")}
                    className="px-6 py-3 border border-gray-300 rounded-lg flex items-center gap-2 font-medium hover:bg-gray-50 transition"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-5 w-5"
