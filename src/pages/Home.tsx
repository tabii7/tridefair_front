  ...
  const deals = [
    {
      ...
      discount: 50,
      image: "https://images.unsplash.com/photo-1586953208448-b95a79798f07?w=500&auto=format&fit=crop",
      price: 4.31
    },
    {
      id: 2,
      ...
      discount: 45,
      image: "https://images.unsplash.com/photo-1617997455403-41f36e9a8c9d?w=500&auto=format&fit=crop",
      price: 9.14
    },
    {
      id: 3,
      ...
      discount: 40,
      image: "https://images.unsplash.com/photo-1618577608401-38de4f0b9ea9?w=500&auto=format&fit=crop",
      price: 1.54
    },
    {
      id: 4,
      ...
      discount: 35,
      image: "https://images.unsplash.com/photo-1612100577176-a433ec5a2f45?w=500&auto=format&fit=crop",
      price: 3.44
    }
  ];
    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="relative h-[400px] rounded-lg overflow-hidden mb-8">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-black/60 to-transparent flex items-center">
          <div className="text-white p-8">
            <h1 className="text-4xl font-bold mb-4">Tech Essentials & Gadgets</h1>
            <p className="text-xl mb-6">Discover amazing deals on charging solutions</p>
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-4">
                <div className="text-white">
                  ...
                  <p className="text-xl font-bold">Up to {deal.discount}% Off</p>
              ...
              <Link to={`/product/${product.id}`}>
                ...
                <div className="p-4">
                  ...
                  <div className="flex justify-between items-center">
                    <div>
                      <p className="text-xl font-bold">${product.discounted_price}</p>
      ...
      <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {[
            { name: 'Chargers', image: 'https://images.unsplash.com/photo-1612100577176-a433ec5a2f45?w=500&auto=format&fit=crop' },
            { name: 'Power Banks', image: 'https://images.unsplash.com/photo-1609091839311-d5365f9ff1c5?w=500&auto=format&fit=crop' },
            { name: 'Cables', image: 'https://images.unsplash.com/photo-1618577608401-38de4f0b9ea9?w=500&auto=format&fit=crop' },
            { name: 'Phone Holders', image: 'https://images.unsplash.com/photo-1617997455403-41f36e9a8c9d?w=500&auto=format&fit=crop' }
          ].map((category) => (
            <Link
              key={category.name}
