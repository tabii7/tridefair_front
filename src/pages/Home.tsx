  ...
  const categories = [
    {
      ...
      image: "https://images.unsplash.com/photo-1618761714954-0b8cd0026356?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60",
      url: "/category/4"
    },
    {
      id: 2,
            ...
            >
              <div className="bg-white rounded-lg shadow overflow-hidden transition-all duration-300 hover:shadow-md">
                ...
                <div className="p-4">
                  ...
                  {category.subtitle && (
                    <p className="mt-1 text-sm text-gray-600">{category.subtitle}</p>
                  )}
                </div>
              </div>
            </Link>
